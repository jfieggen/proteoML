...
# Set up logging
log_path = '/well/clifton/users/ncu080/UKB_Project/logs/search_xgb.log'
...
param_grid = {
    ...
    "max_depth": [3],  # Slightly lower values to prevent overfitting
    "min_child_weight": [2],  # Include higher values to prevent overfitting
    "gamma": [0],  # Exploring slightly higher values
    "subsample": [0.6],  # Narrowing around 0.6 and 0.8
    "colsample_bytree": [0.6],  # Include a slightly higher value
    "reg_lambda": [1],  # Narrowing around the best performing values
    "reg_alpha": [0]  # Exploring more values around the best performing ones
}  
...
model_path_pkl = '/well/clifton/users/ncu080/UKB_Project/models/search_xgb_gs_test.pkl'
