...
# Set up logging
log_path = '/well/clifton/users/ncu080/UKB_Project/logs/search_xgb_2.log'
...
param_grid = {
    ...
    "n_estimators": [50, 500],  # Include a lower value to prevent overfitting
    "max_depth": [3, 7],  # Slightly lower values to prevent overfitting
    "min_child_weight": [2, 4],  # Include higher values to prevent overfitting
    "gamma": [0],  # Exploring slightly higher values
    "subsample": [0.6, 0.8],  # Narrowing around 0.6 and 0.8
    "colsample_bytree": [0.6, 0.8],  # Include a slightly higher value
    "reg_lambda": [1, 4],  # Narrowing around the best performing values
    "reg_alpha": [0, 1]  # Exploring more values around the best performing ones
}  
...
model_path_pkl = '/well/clifton/users/ncu080/UKB_Project/models/search_xgb_gs2.pkl'
